...
namespace Seed
{
	...
	/*	inline static void drawTriangle(void *v, int n, int perSize, FVF fvf) {
		...
		virtual VertexBuffer* createVertexbuffer(const u32 &n, const VertexDeclaration &decl);
		IndexBuffer* createIndexbuffer16(u32 num);
		void renderGeometry(Geometry *geo);
